...
| **J** | `Video File` | Tên file video xuất bản (VD: `#1.HSK 1 • Đồ Ăn & Thức Uống.mp4`) |
| **K** | `GDrive Link` | Đường dẫn trực tiếp file video trên Google Drive |
| **L** | `Created At` | Ngày giờ tạo dữ liệu (`YYYY-MM-DD HH:MM:SS`) |
| **M** | `Notes` | Ghi chú nguồn tạo batch |

### 4.2. Google Drive (Kho lưu trữ video thành phẩm)
...
- **Quy tắc đặt tên video:** `#{Số dòng}.{Tên topic}.mp4`
