...
# 1. Kích hoạt môi trường (sử dụng .venv ở thư mục mẹ hoặc thư mục hiện tại):
source ../.venv/bin/activate

# 2. Render tất cả hàng 'Pending' trong Google Sheet và upload lên Google Drive:
...
# 4. Chạy trực tiếp file kịch bản độc lập (render nhanh test preview 480p):
